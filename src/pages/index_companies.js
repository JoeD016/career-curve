        ...
        <main className="container mx-auto p-6 w-5/6">
          ...
          <section className="bg-white rounded-lg p-6 mb-6 border border-blue-100 flex flex-col items-center italic">
            <div className="text-blue-800 text-4xl space-y-6 text-center">
              ...
              <p className="text-3xl font-semibold text-2xl">
                It's time to break free from the ordinary and transform your
                hiring strategy into something extraordinary.
              </p>
              <p className="text-3xl font-semibold text-2xl">
          ...
          <section className="bg-white rounded-lg p-6 mb-6 border border-blue-100 text-justify">
            <p className="text-3xl text-blue-1000 italic">
              With CareerCurve, you can{" "}
              <span className="text-blue-400 font-bold italic">streamline</span>{" "}
              your hiring process, access a curated pool of{" "}
              <span className="text-blue-400 font-bold italic">
                qualified candidates
              </span>
              , and discover individuals who align perfectly with your{" "}
              <span className="text-blue-400 font-bold italic">
                company's vision
              </span>
              . Our platform utilizes advanced algorithms and machine learning
            ...
            <ul className="space-y-4">
              <li className="flex flex-col items-center">
                ...
                <span className="text-3xl font-semibold text-blue-1000">
                  Tailored applicants recommendations
                </span>
              </li>
              <li className="flex flex-col items-center">
                <span className="material-icons text-blue-500 text-8xl">
              ...
              <li className="flex flex-col items-center">
                ...
                <span className="text-3xl font-semibold text-blue-1000">
                  Aspiration oriented match making
                </span>
              </li>
            </ul>
          ...
          <section className="bg-white rounded-lg p-6 border border-blue-100 text-justify italic">
            <p className="text-3xl">
              Join us and unlock a world of{" "}
              <span className="text-blue-400 font-bold italic">
                recruitment possibilities
              </span>
              . Take the first step toward building a team of{" "}
              <span className="text-blue-400 font-bold italic">
              ...
              ,<span className="text-blue-400 font-bold italic"> values</span>,
              and the
              <span className="text-blue-400 font-bold italic"> skills </span>
              you're seeking in candidates and let us find the{" "}
              <span className="text-blue-400 font-bold italic">
                perfect talents{" "}
              </span>
              to drive your company's{" "}
              <span className="text-blue-400 font-bold italic">success</span>.
            </p>

            <p className="text-3xl">
              Sign up now and let CareerCurve guide you toward the perfect

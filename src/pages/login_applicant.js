        ...
        <main className="container mx-auto p-6 max-w-none">
          ...
          <div className="flex items-center justify-center bg-gray-100">
                <div className="bg-white shadow-md rounded-lg p-8 w-1/4">
                    ...
                    <form>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-3xl font-bold mb-2" htmlFor="email">
                            Email
                            </label>
                            <input
                        ...
                        <div className="mb-6">
                            <label className="block text-gray-700 text-3xl font-bold mb-2" htmlFor="password">
                            Password
                            </label>
                            <input
                            className="shadow appearance-none border rounded w-full py-4 px-5 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div className="flex items-center justify-between ">
                            ...
                            <Link href="/" className="inline-block align-baseline font-bold text-2xl text-blue-500 hover:text-blue-800">
                                Forgot Password?
                            </Link>
                        </div>
                    </form>
